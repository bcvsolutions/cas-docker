...
- **CAS_CUSTOM_FRONTEND_PASSWORDRESET_LINK** - Set relative(/link), domain relative (\~/link) or full url(with http) link `cas.custom.frontend.passwordReset.link`. **Default: `~/passwordReset`**.
